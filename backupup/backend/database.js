      ...
      throw err
        ...
        (err) => {
            if (err) {
                ...
                // Table just created - no default data seeded for production
                // Model versions will be created by admin users when projects are added
            }
        });
        ...
        db.run(`CREATE TABLE IF NOT EXISTS project_assets (
            ...
            if (err) {
                ...
                // Production: No default empty rows seeded
                // Project assets will be added by admin users when projects are created
            }
        });
        ...
        db.run(`CREATE TABLE IF NOT EXISTS projects (
            ...
            if (err) {
                ...
                // Production: No default projects seeded
                // Projects will be added by admin users through the admin panel
            }
        });
        ...
        db.run(`CREATE TABLE IF NOT EXISTS users (
            ...
            db.run('ALTER TABLE users ADD COLUMN logo_url TEXT', [], (err) => {
                if (err && !err.message.includes('duplicate column name')) {
                    console.error('Failed to add logo_url column:', err);
                }
            });
        });
